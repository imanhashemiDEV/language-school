...
class extends Component {
    ...
    public function setEditCategory($id, $title)
    {
                ...
                <div class="col-span-12">
                    ...
                    <div class="mt-3.5 flex flex-col gap-8">
                        ...
                        <div class="box box--stacked flex flex-col">
                            <div class="flex flex-col gap-y-2 p-5 sm:flex-row sm:items-center">
                                <div>
                                    <div class="relative">
                                        ...
                                        <input wire:model="search" @keyup.enter="$wire.searchCategory" data-tw-merge=""
                                               type="text" placeholder="جستجوی دسته بندی..."
                            ...
                            <div class="overflow-auto xl:overflow-visible mt-2">
                                <table data-tw-merge=""
                                        ...
                                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                                            ...
                                            <td data-tw-merge=""
                                                ...
                                                <div class="whitespace-nowrap">
                                                    {{ \Hekmatinasser\Verta\Facades\Verta::instance($category->created_at)->formatJalaliDate() }}
                                                </div>
                                            </td>
                                            ...
                                            <td data-tw-merge=""
                                                class="px-5 border-b dark:border-darkmode-300 border-dashed py-4 dark:bg-darkmode-600">
                                                @if($editCategory==$category->id)
                                                    <x-fas-save wire:click="updateCategory"
                                                                class="text-success h-6 w-6"/>
                                                @else
                                                    <x-fas-edit
                                                        wire:click="setEditCategory('{{$category->id}}', '{{$category->title}}')"
                                                        class="text-info h-6 w-6"/>
                                                @endif
                                                    <x-fas-trash class="text-info h-6 w-6"/>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                            ...
                            <div
                                ...
                                {{ $this->categories->links('admin.layouts.pagination') }}
                            </div>
                        </div>
                    </div>
                </div>
