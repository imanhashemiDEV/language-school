...
<!-- END: Head -->
<body>
<div class="container mx-auto flex items-center justify-center px-5 py-2 sm:px-10 sm:py-14 md:px-36 lg:h-screen lg:max-w-[1550px] lg:py-0 lg:pl-5 lg:pr-5 xl:px-24 2xl:max-w-[1750px]">
    <div class="relative z-50 w-1/2 border border-gray-200  sm:p-14 bg-white rounded-2xl lg:bg-transparent lg:pr-10  rtl:xl:pl-24 ltr:xl:pr-24 lg:p-0 before:content-[''] before:absolute before:inset-0 before:-mb-3.5 before:bg-white/40 before:rounded-2xl before:mx-5">
        <div class="relative z-10 flex h-full w-full flex-col justify-center py-2 lg:py-10">
